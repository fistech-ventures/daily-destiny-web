...
export default function BlinkingLiveButton() {
  ...
  return (
    <Link href="/video/live" className="">
      <Button className="flex items-center gap-2.5 rounded-full bg-brand w-full py-5 font-bold text-white shadow-lg transition-transform hover:scale-105 animate-shadow-blink">
