...
export default function Headline({ headlines }: { headlines: { title: string, code: string, category: string }[] }) {
  ...
  return (
    <div className="no-print sticky top-0 z-50 w-full bg-background flex items-center overflow-hidden h-8 lg:h-10 border-b border-[#000058]">
      <div className="z-10 flex bg-[#000058] px-2 lg:px-10 h-full w-[100px] flex justify-center  items-center gap-2 shrink-0 shadow-[4px_0_10px_rgba(0,0,0,0.1)]">
