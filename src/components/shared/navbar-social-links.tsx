...
export function NavbarSocialLinks({
    ...
    return (
      <div className="flex flex-col items-center gap-4 w-full py-2">
        ...
        <div className="flex items-center justify-center gap-2.5 sm:gap-3">
          ...
          {/* LinkedIn - NOW VISIBLE IN HAMBURGER MENU */}
          ...
          <SocialIcon bgColor="#1877F2" href="https://facebook.com/groups">
            <Users
              size={16}
              color="#ffffff"
              className="stroke-[2] h-[18px] w-[18px]"
            />
          </SocialIcon>
  ...
  // MODIFIED: LinkedIn hidden on mobile, visible on desktop
  // ════════════════════════════════════════════════
  return (
    <>
      <div className="relative flex items-center gap-1.5 md:gap-2.5">
        {/* ১. Facebook and YouTube (Always visible on mobile) */}
        <SocialIcon
          bgColor="#1877F2"
          href="https://www.facebook.com/DailyDestinyBD"
        >
        ...
        {/* LinkedIn - HIDDEN ON MOBILE, VISIBLE ON DESKTOP (md and up) */}
        ...
        {/* ३. "More" বাটন (শুধু মোবাইল স্ক্রিনের সাধারণ নেভবারে দেখাবে) */}
        <button
      ...
      {/* ४. মোবাইল পপ-আপ ওভারলে মেনু (Opens when "More" button is clicked) */}
      {mounted && isPopupOpen
        ? createPortal(
