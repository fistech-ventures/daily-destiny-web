  ...
  return (
    <div className=" w-full overflow-hidden  pb-2 lg:pb-4">
      <div className="relative flex h-14 w-full items-center overflow-hidden bg-transparent border-y shadow-sm">
        <div className="z-20 flex h-full w-[1px] items-center bg-transparent whitespace-nowrap  p-0 py-0 text-sm font-semibold text-primary-foreground shadow-[4px_0px_10px_rgba(0,0,0,0.1)]">
