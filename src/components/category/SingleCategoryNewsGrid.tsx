  ...
  return (
    <div className="w-full flex flex-col gap-4 select-none">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 mt-2">
        ...
        {featuredArticle && (
          <div className="lg:col-span-1 flex flex-col bg-white border border-gray-200 rounded-md p-4 shadow-xs">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          {secondaryArticles.map((article: Article, idx: number) => (
            <Link 
              ...
              className="group flex gap-4 bg-white border border-gray-150 rounded-md p-3 shadow-xs hover:border-gray-300 transition-all items-center"
            >
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-base font-bold text-gray-800 leading-snug group-hover:text-blue-600 transition-colors line-clamp-2 sm:line-clamp-3">
                  {article.title}
                </h4>
                {article.excerpt && (
